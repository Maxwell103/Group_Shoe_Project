...
with open("./weights/le_material.pkl", "rb") as f:
    le_material = pickle.load(f)

with open("./weights/le_productgroup.pkl", "rb") as f:
    le_productgroup = pickle.load(f)

with open("./weights/le_sub_productgroep.pkl", "rb") as f:
    le_sub_productgroep = pickle.load(f)

with open("./weights/le_return_rate.pkl", "rb") as f:
...
with left_column:
    ...
    """)
    st.image("https://www.google.com/imgres?imgurl=https%3A%2F%2Fwww.schoenvisie.nl%2Fapp%2Fuploads%2F2020%2F01%2Fmcgregor1-2020-1-1024x1024.jpg&tbnid=ii4ofvYIy7Ce6M&vet=12ahUKEwi92bL5ucf_AhVKhP0HHSFpDSYQMygCegQIARB8..i&imgrefurl=https%3A%2F%2Fwww.schoenvisie.nl%2Fvan-gastel-shoes-gaat-samenwerken-met-mcgregor%2F&docid=bo-2hMpMkrGB9M&w=1024&h=1024&q=van%20gastel%20shoes&ved=2ahUKEwi92bL5ucf_AhVKhP0HHSFpDSYQMygCegQIARB8", caption='Project Image', use_column_width=True)  # Insert your image path here
